...
import { Grid2Frame, Grid2TextFrame, Grid2TextCompactFrame, HeroFrame, HeroListFrame, Grid3Frame, ListFrame } from './components.jsx';
...
export const CATEGORY_FRAMES = {
  ...
  grid2textcompact: { label: '2 columnas sin descripción', Component: Grid2TextCompactFrame },
