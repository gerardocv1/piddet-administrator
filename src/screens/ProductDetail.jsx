...
import { Button, IconButton, RefreshButton, Badge, Input, MoneyInput, Textarea, Select, Switch, Modal, Spinner, Alert, useToast } from '../components';
...
const GROUP_TYPE_OPTION = 'OPTION';
const GROUP_TYPE_REMOVE = 'REMOVE';
const GROUP_TYPES = [
...
const isRemoveGroup = (g) => g?.type === GROUP_TYPE_REMOVE;
...
export function ProductDetail() {
  ...
  return (
    <div className={s.page}>
      ...
      {optForm && (
        <OptionModal itemId={itemId} groupId={optForm.groupId} groupType={optForm.groupType} option={optForm.option}
...
function OptionModal({ itemId, groupId, groupType, option, onClose, onSaved }) {
  const { toast } = useToast();
